...
const ProductDetail: FC = () => {
  ...
  return (
    <Page id="product-detail" className={styles['product-detail']} title={t('pacts.pro.long-title')} isNeedH1>
      <GeneralTemplate modifiers="padding-bottom">
        <SectionPack
          ...
          checkList={[
            ...
            t('pacts.pro.checklist.07'),
            t('pacts.pro.checklist.08'),
            t('pacts.pro.checklist.09'),
            t('pacts.pro.checklist.10'),
            t('pacts.pro.checklist.11'),
            t('pacts.pro.checklist.12'),
          ]}
          imgSrc="/images/product/image-1.png"
        >
          <Text>
            {t('pacts.pro.paragraph01')}
            <br />
            <br />
            {t('pacts.pro.paragraph02')}
          </Text>
        </SectionPack>
