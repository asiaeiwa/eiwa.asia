...
const ServiceEnterprise: FC = () => {
  ...
  return (
    <Page
      ...
      keywords={t('keywords')}
      imgFeatureSrc="/images/service/enterprise-sofware-development/image-3.jpg"
    >
      <GeneralTemplate modifiers="no-top">
        <ServiceIntro title={t('title')} imgSrc="/images/service/enterprise-sofware-development/intro-bg.jpeg">
          <Text>{t('description')}</Text>
        </ServiceIntro>
        <ServiceArticle
          title={t('section-01.title')}
          imgSrc="/images/service/enterprise-sofware-development/image-1.jpg"
        >
        ...
        <ServiceArticle
          ...
          imgSrc="/images/service/enterprise-sofware-development/image-2.jpg"
        >
