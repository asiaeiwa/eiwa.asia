  ...
  return (
    ...
    >
      <GeneralTemplate modifiers="no-top">
        ...
        <ServiceArticle title={t('section-03.title')} imgSrc="/images/services/it-solution-consulting/image-3.jpg">
          <ul>
        ...
        <ServiceArticle
          ...
          imgSrc="/images/services/it-solution-consulting/image-4.jpg"
        >
